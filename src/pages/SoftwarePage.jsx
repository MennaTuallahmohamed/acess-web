...
function getLoggedUserId(currentUser) {
...
function normalizeSolution(raw, index = 0) {
  const source =
    raw?.solution ||
    raw?.issueSolution ||
    raw?.solutionAction ||
...
.software-page{
  ...
  padding:22px;
  background:
    radial-gradient(circle at top left, rgba(28,169,225,.18), transparent 30%),
    radial-gradient(circle at top right, rgba(38,55,70,.10), transparent 30%),
...
.sw-hero{
  ...
  color:#fff;
  box-shadow:0 22px 55px rgba(28,169,225,.25);
  display:flex;
...
.sw-tab.active{
  background:${SMART.dark};
  color:white;
  border-color:${SMART.dark};
}
...
.sw-stat:before{
  ...
  inset:0 0 auto 0;
  height:4px;
  background:linear-gradient(90deg,${SMART.blue},${SMART.dark});
}
...
@media(max-width:650px){
  ...
  .sw-logo{width:50px;height:50px}
  .sw-tabs{grid-template-columns:1fr}
...
export function SoftwarePage({ currentUser }) {
    ...
    <section className="software-page">
      <div className="sw-hero">
        <div className="sw-brand">
          <div className="sw-logo">SMART IT</div>
                        ...
                        >
                          ...
                          <div className="sw-item-actions">
                            ...
                            <button
                              ...
                              onClick={() => openIssueModal(task, item)}
                            >
                              Issue Steps
                            </button>
                            ...
                            <button
                              ...
                              onClick={() => quickNotReachable(task, item)}
                            >
                              Not Reachable
                            </button>
                          </div>
          ...
          <div className="sw-morpho-layout">
            <aside className="sw-filter-box">
              <div className="sw-stack">
                ...
                <button className="sw-btn" onClick={loadDevices}>
                  Refresh Devices
                </button>
              </div>
            </aside>
        ...
        <div className="sw-modal-backdrop">
          <div className="sw-modal">
            <div className="sw-modal-head">
              ...
              <button className="sw-close" onClick={() => setIssueModal(null)}>
                ×
              </button>
            </div>
            ...
            <div className="sw-modal-foot">
              <button className="sw-btn white" onClick={() => setIssueModal(null)}>
                Cancel
              </button>
        ...
        <div className="sw-modal-backdrop">
          <div className="sw-modal">
            <div className="sw-modal-head">
              ...
              <button className="sw-close" onClick={() => setMorphoModal(null)}>
                ×
              </button>
            </div>
            ...
            <div className="sw-modal-foot">
              <button className="sw-btn white" onClick={() => setMorphoModal(null)}>
                Cancel
              </button>
